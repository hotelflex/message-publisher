...
} = require('../relations/belongsToOne/BelongsToOneRelation')
const {
  HasOneThroughRelation,
} = require('../relations/hasOneThrough/HasOneThroughRelation')

const {
  InstanceFindOperation,
} = require('../queryBuilder/operations/InstanceFindOperation')
const {
  InstanceInsertOperation,
} = require('../queryBuilder/operations/InstanceInsertOperation')
const {
  InstanceUpdateOperation,
} = require('../queryBuilder/operations/InstanceUpdateOperation')
const {
  InstanceDeleteOperation,
} = require('../queryBuilder/operations/InstanceDeleteOperation')
...
class Model {
  ...
  $loadRelated(relationExpression, modifiers, trx) {
    return this.constructor.loadRelated(
      this,
      relationExpression,
      modifiers,
      trx,
